...
- [ ] Ajouter les Lycées Professionnels avec les classes suivantes :  Seconde Bac pro, Première Bac pro, Terminale Bac pro, Seconde CAP, Terminale CAP.
- [ ] Classes pour le Post bac : CPGE, Licence universitaire, Master universitaire, BTS, Ecole supérieure, 
- [ ] Ajouter enseignement adapté dans Niveau
...
- [ ] Remplacer l’email dans le bilan des activités par le nom de la pratique
- [ ] Dans le bureau d’accueil, afficher le picrat art
<<<<<<< HEAD
- [ ] Enlever la clé primaire du tableau des activités
